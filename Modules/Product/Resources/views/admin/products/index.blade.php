                    ...
                    <table class="data-table table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('product::products.table.description') }}</th>
                                <th>{{ trans('product::products.table.image') }}</th>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-danger btn-flat" data-toggle="modal"
                                            ...
                                            data-action-target="{{ route('admin.product.product.destroy', [$product->id]) }}"><i
